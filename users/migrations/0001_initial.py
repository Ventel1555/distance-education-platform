    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('S', 'Ученик'), ('T', 'Учитель'), ('A', 'Администратор')], max_length=8, verbose_name='Роль')),
                ('feedback', models.BooleanField(default=False, verbose_name='Доступ к обрат. связи')),
                ('class_id', models.ManyToManyField(to='edu.classes', verbose_name='Классы')),
